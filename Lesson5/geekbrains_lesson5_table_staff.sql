...
(17, '', 'Елена', 'Чернова', 4, 'Юрист', 60000),
(18, '', 'Дмитрий', 'Сорокин', 6, 'Маркетолог', 60000),
(19, '', 'Самуил', 'Бобырев', 8, 'Охранник', 40000);

--
-- Триггеры `staff`
--
DELIMITER $$
CREATE TRIGGER `bonus` AFTER INSERT ON `staff` FOR EACH ROW BEGIN
